...
SOURCES = {
    ...
    "korea:Lotto 6/45": dict(url="https://www.dhlottery.co.kr/lt645/stats", main_max=45, main_count=6),
...
def main() -> int:
    ...
    for key, config in SOURCES.items():
        try:
            ...
            entry.update(status="ok", updated=today, main=main_numbers, mainCounts=main_counts)
            if config.get("special_count"):
